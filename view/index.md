...
- [history/index.md](./history/index.md): Historical portfolio summary page with stacked chart and a scrollable monthly table that keeps its header visible, opens on the newest month, and reserves currency prefixes for summary and total values.
