...
- [dashboard/index.md](./dashboard/index.md): Main portfolio overview page with refresh progress, pie chart rendering, and shared whole-number full-value labels that can switch to compact formatting from Settings.
