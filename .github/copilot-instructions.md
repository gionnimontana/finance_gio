...
- `src/**/index.md` and `view/**/index.md` describe current code structure and folder responsibilities.
...
- Keep `src/index.md`, `view/index.md`, and `docs/index.md` as the root entry points.
...
- Do not mirror every code edit into `docs/`, and do not duplicate folder inventories that already belong in `src/**/index.md` or `view/**/index.md`.
