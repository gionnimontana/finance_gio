...
- [index.js](./index.js): Express bootstrap that loads environment variables, serves the frontend, exposes auth and portfolio APIs, and provides the health endpoint used by local automation.
