...
- [index.js](./index.js): Express bootstrap that loads environment variables, serves the frontend, redirects root and unknown non-asset app URLs to the login entrypoint, exposes auth and portfolio APIs, and provides the health endpoint used by local automation.
