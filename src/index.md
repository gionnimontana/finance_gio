...
- [scripts/index.md](./scripts/index.md): Higher-level backend business logic plus the deploy-time frontend release builder used for cache-busted production assets.