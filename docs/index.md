...
- [frontend-cache.md](./frontend-cache.md): Production frontend cache-control strategy covering Nginx ownership of static pages, deploy-time asset versioning, and the exact API routes that still proxy to Express.
