...
- [scraper-runtime.md](./scraper-runtime.md): Fallback-provider runtime notes covering cache TTLs, stale-value reuse, and deterministic scraper regression tests.
